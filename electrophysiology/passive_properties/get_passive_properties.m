...
I_baseline = nanmedian(tracevals(pulse_end - 600:pulse_end - 100)); %calculate the median baseline current (during the V step)
I_baseline_std = nanstd(tracevals(pulse_end - 600:pulse_end - 100));
